...
describe "Results API" do
  it "sends the results of the machine learning" do
    get "/api/v1/results?age=12&name=grant-ward&gender=afab&country_of_origin=madagascar&group_size=3&country_of_seperation=madagascar&client_id=#{ENV['CLIENT_ID']}&client_secret=#{ENV['CLIENT_SECRET']}"
  ...
  it "sends the results of the machine learning again" do
    get "/api/v1/results?age=50&name=richard-ward&gender=amab&country_of_origin=iran&group_size=3&country_of_seperation=turkey&client_id=#{ENV['CLIENT_ID']}&client_secret=#{ENV['CLIENT_SECRET']}"
